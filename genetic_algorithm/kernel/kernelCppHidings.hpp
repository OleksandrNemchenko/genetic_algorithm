...
#ifndef _OPENCL_KERNEL_CPP_HIDINGS_H_
#define _OPENCL_KERNEL_CPP_HIDINGS_H_
...
// general
#define get_global_id(x) openClEmulator::global_id[x] // global index
#define get_global_size(x) openClEmulator::global_size[x] // global range
#define get_local_id(x) openClEmulator::local_id[x] // local index within group
#define get_local_size(x) openClEmulator::local_size[x] // group size
#define	get_num_groups(x) openClEmulator::num_groups[x] // number of groups
#define get_group_id(x) openClEmulator::group_id[x] // group ID
#define get_global_offset(x) openClEmulator::global_offset[x] // global offset
...
#endif // _OPENCL_KERNEL_CPP_HIDINGS_H_
